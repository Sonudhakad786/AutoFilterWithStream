...
PICS = (environ.get('PICS', 'https://graph.org/file/b71953969b94e99e9e4ff.jpg')).split()   

NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b71953969b94e99e9e4ff.jpg")
...
HOW_TO_DOWNLOAD = environ.get('HOW_TO_DOWNLOAD', "https://t.me/super4crazy/12782")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1002138468489")) 
...
URL = "https://filestream-super4crazy.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filestream-super4crazy.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filestream-super4crazy.koyeb.app/".format(FQDN)
else:
    URL = "https://filestream-super4crazy.koyeb.app/".format(FQDN)
